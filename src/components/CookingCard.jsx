const CookingCard = ({order , handleCompleteCook}) => {
  // Mock data
//   const order = {
...
//   };
  ...
  return (
    ...
    >
      ...
      {/* Static Button */}
      <button onClick={()=> handleCompleteCook(order)} className="px-6 mt-3 py-1 shadow text-sm hover:bg-black hover:text-white bg-white cursor-pointer rounded-xl">
        Cooked?
      </button>
    </div>
  );
